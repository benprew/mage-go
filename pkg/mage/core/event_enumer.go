...
const _EventTypeName = ""

var _EventTypeIndex = [...]uint16{0, 10, 22, 39, 56, 72, 87, 98, 108, 116, 125, 134, 150, 156, 162, 193, 199, 207, 218, 225, 231, 241, 253, 264, 278, 287, 294, 308, 323, 337, 341, 348, 357, 370}

const _EventTypeLowerName = ""
