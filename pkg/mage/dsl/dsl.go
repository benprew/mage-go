...
type (
	...
	ControlConditionData                      = mage.ControlConditionData
	ControlEffectSpec                         = mage.ControlEffectSpec
	ControlSourceExists                       = mage.ControlSourceExists
	ControlSourceControlledByEffectController = mage.ControlSourceControlledByEffectController
	ControlSourceTapped                       = mage.ControlSourceTapped
	ControlTargetPowerLESource                = mage.ControlTargetPowerLESource
...
var (
	...
	ControlAttached                            = mage.ControlAttached
	ControlSourceByChosenPlayer                = mage.ControlSourceByChosenPlayer
	GainControl                                = mage.GainControl
...
var (
	...
	ReturnTargetFromAnyGraveyardToBattlefield = mage.ReturnTargetFromAnyGraveyardToBattlefield
