...
func TestLandTax(t *testing.T) {
	...
	t.Run("may find fewer than three basic lands", func(t *testing.T) {
		g := gametest.NewTestGame(t)
		g.AddCard(core.ZoneBattlefield, gametest.PlayerA, "Land Tax")
		g.AddCard(core.ZoneBattlefield, gametest.PlayerB, "Mountain")
		g.AddCard(core.ZoneLibrary, gametest.PlayerA, "Plains")
		...
		g.AddCard(core.ZoneLibrary, gametest.PlayerA, "Plains")
		g.ChooseFromLibrary(gametest.PlayerA, "Plains")
		g.StopChoosingFromLibrary(gametest.PlayerA)
		g.StopAt(1, core.PrecombatMain)
		g.Execute()
		g.AssertHandCount(gametest.PlayerA, "Plains", 1)
		g.AssertLibraryCount(gametest.PlayerA, "Plains", 2)
	})
	t.Run("may find no basic land at all", func(t *testing.T) {
		g := gametest.NewTestGame(t)
		g.AddCard(core.ZoneBattlefield, gametest.PlayerA, "Land Tax")
		g.AddCard(core.ZoneBattlefield, gametest.PlayerB, "Mountain")
		g.AddCard(core.ZoneLibrary, gametest.PlayerA, "Plains")
