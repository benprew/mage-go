...
func (t *GenericTriggered) CheckTrigger(evt *GameEvent, g *Game) bool {
	...
	return t.Condition(evt, g, t.Source_, t.Controller_)
}

func (t *GenericTriggered) IsOptional() bool  { return t.Optional_ }
func (t *GenericTriggered) Effects() []Effect  { return t.Effs }
func (t *GenericTriggered) Targets() []Target  { return t.Tgts }
